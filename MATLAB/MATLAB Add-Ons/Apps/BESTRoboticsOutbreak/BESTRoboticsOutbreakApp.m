classdef BESTRoboticsOutbreakApp < handle
    %
    % Usage:
    %     app.BESTRoboticsOutbreakApp
    ...
    properties (Constant)
        AppPathBase = {'/BESTRoboticsOutbreak'};
        AppClass = 'BESTRoboticsOutbreakApp';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function obj = BESTRoboticsOutbreakApp()
        ...
        function startApp(obj)
            ...
            mlock;
            BESTRoboticsOutbreakApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'BEST_Outbreak_App')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong BEST_Outbreak_App
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'BEST_Outbreak_App').getString, ...
            ...
            if nargout(@BEST_Outbreak_App) == 0
                eval('BEST_Outbreak_App');
            else
                obj.AppHandle = eval('BEST_Outbreak_App');
            end
