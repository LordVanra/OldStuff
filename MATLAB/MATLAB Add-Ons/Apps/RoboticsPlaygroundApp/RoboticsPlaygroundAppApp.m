classdef RoboticsPlaygroundAppApp < handle
    %
    % Usage:
    %     app.RoboticsPlaygroundAppApp
    ...
    properties (Constant)
        AppPathBase = {'/RoboticsPlaygroundApp'};
        AppClass = 'RoboticsPlaygroundAppApp';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function obj = RoboticsPlaygroundAppApp()
        ...
        function startApp(obj)
            ...
            mlock;
            RoboticsPlaygroundAppApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'RP_App')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong RP_App
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'RP_App').getString, ...
